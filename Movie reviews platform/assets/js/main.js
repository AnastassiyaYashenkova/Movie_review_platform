...
// переменные
const siteName = "MovieReview";
let totalMovies = 50;
let isLoggedIn = false;

//строки и математика
console.log("Welcome to " + siteName);
console.log("Movies: " + (totalMovies + 10));
...
//api
const API_KEY = "744334d6"; // твой рабочий ключ OMDb
const imdbIDs = ["tt0111161", "tt0068646", "tt0468569", "tt1375666", "tt0137523"]; // проверенные ID
